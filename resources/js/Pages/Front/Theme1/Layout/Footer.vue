                ...
                <div class="footer-right ml-auto mt-1 mt-sm-0">
                    <div class="payment-icons mr-0">
                        <span class="payment-icon visa"
                            :style="`background-image: url(${asset('front/theme1/images/payments/payment-visa.svg')})`"></span>
                        <span class="payment-icon paypal"
                            :style="`background-image: url(${asset('front/theme1/images/payments/payment-paypal.svg')})`"></span>
                        <span class="payment-icon stripe"
                            :style="`background-image: url(${asset('front/theme1/images/payments/payment-stripe.png')})`"></span>
                        <span class="payment-icon verisign"
                            :style="`background-image: url(${asset('front/theme1/images/payments/payment-verisign.svg')})`"></span>
                    </div>
                </div>
            </div>
        </div>
