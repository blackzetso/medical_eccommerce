...
function submit() {
  form.post(route('admin.settings.about.update'), {
    onSuccess: () => {
      toast.success("تم تحديث محتوى صفحة من نحن بنجاح", {
        position: "top-right",
        autoClose: 3000,
      })
    }
    ...
    <div class="page-content-wrapper border">
      <div class="row">
        <div class="col-12 mb-3">
          <h1 class="h3 mb-2 mb-sm-0">من نحن</h1>
        </div>
      </div>
        ...
        <div class="col-xl-9">
          <div class="card shadow">
            <div class="card-header border-bottom p-4">
              <h5 class="card-header-title mb-0">محتوى صفحة من نحن</h5>
            </div>
