...
class EnglishTranslationKeysSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = [
            ...
            'weight_kg' => 'Weight (kg)',
            'dimensions_format' => 'Dimensions (L × W × H)',
            'classification' => 'Classification',
            'meta_title' => 'Meta Title',
            'meta_description' => 'Meta Description',
            'add_new_product' => 'Add New Product',
            'product_added_to_cart_success' => 'Product added to cart successfully',
            'product_added_to_favorites_success' => 'Product added to favorites successfully',
            'product_not_available_in_stock' => 'Product not available in stock',
            'please_select_all_required_attributes' => 'Please select all required attributes',
            ...
            'lets_learn_today' => 'Let\'s Learn Today',
            'clients_joined_us' => 'Clients Joined Us',
            'login_to_medical_media' => 'Login to Medical Media',
            ...
            'get_latest_info' => 'Get Latest Info',
            ...
            'designed_and_developed_by' => 'Designed and Developed by Semicolon Solutions',
            ...
            'error_adding_to_favorites' => 'Error occurred while adding product to favorites',
        ];
